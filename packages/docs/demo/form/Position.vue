...
import { HsMessage, type FormProps } from "hs-element-ui";
...
<template>
  ...
  <hs-form :model="form" :label-position="labelPosition">
    <hs-form-item label="Activity name">
      <hs-input v-model="form.name" />
    </hs-form-item>
    <hs-form-item label="Activity zone">
      <hs-select
        v-model="form.region"
